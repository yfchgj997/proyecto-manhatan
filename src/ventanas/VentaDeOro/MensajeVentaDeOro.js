...
function CargarMensajeVentaDeOro(mensaje) {

    // mansaje de flujo
    console.log("MENSAJE: cargaremos el componente mensaje")

    // Paso -> obtener el espacio del mensaje
    let EspacioMensajeVentaDeOro = document.getElementById("EspacioMensajeVentaDeOro")
    if (EspacioMensajeVentaDeOro) {// se encontro el espacio
        ...
        EspacioMensajeVentaDeOro.innerHTML = codigo
...
module.exports = { CargarMensajeVentaDeOro };