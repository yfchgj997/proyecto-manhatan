...
// Funciones
    ...
    function CargarMensajeMovimiento (mensaje){
        ...
        let EspacioMensajeMovimiento = document.getElementById("EspacioMensajeMovimiento")
        if(EspacioMensajeMovimiento){// se encontro el espacio
            ...
            EspacioMensajeMovimiento.innerHTML = codigo
