    ...
    if (Respuesta.error == true) {
        ...
        switch (Operacion) {
            case "Aumentar":
                ...
                SaldoFinal = (parseFloat(DetalleCliente.SaldoEconomico) + parseFloat(Monto)).toFixed(2)
                break
            case "Disminuir":
...
function ModificarSaldoMaterial(Operacion, Monto, IDCliente) {
    ...
    if (Respuesta.error == true) {
        ...
        switch (Operacion) {
            case "Aumentar":
                SaldoFinal = (parseFloat(DetalleCliente.SaldoMaterial) + parseFloat(Monto)).toFixed(2)
                break
            case "Disminuir":
                SaldoFinal = (parseFloat(DetalleCliente.SaldoMaterial) - parseFloat(Monto)).toFixed(2)
                break
